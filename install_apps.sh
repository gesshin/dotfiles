...
yay polybar rofi nitrogen wpgtk-git ranger 

# Install shell and custom prompt
sudo pacman -S fish
curl -fsSL https://starship.rs/install.sh | bash

# Install theme manager, gtk theme, icon theme, cursor theme, ui font, terminal font, font aggregator
yay lxappearance nordic-theme-git qogir-icon-theme mcmojave-cursors ttf-roboto ttc-iosevka-ss04 nerd-fonts-symbols
